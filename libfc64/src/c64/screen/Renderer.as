			...
			for ( var xDisp:int = 0; xDisp < 316; xDisp += 8 )
			{
				...
				if ( !isMultiColor || ( c < 8 ) )
				{
					...
					else if ( b != 0x00 )
					{
						...
						if ( b & 0x1 )
						{
							displayFore.setPixel32( x + 7, y, foregroundColor );
						}
						if ( b & 0x2 )
						{
							displayFore.setPixel32( x + 6, y, foregroundColor );
						}
						if ( b & 0x4 )
						{
							displayFore.setPixel32( x + 5, y, foregroundColor );
						}
						if ( b & 0x8 )
						{
							displayFore.setPixel32( x + 4, y, foregroundColor );
						}
						if ( b & 0x10 )
						{
							displayFore.setPixel32( x + 3, y, foregroundColor );
						}
						if ( b & 0x20 )
						{
							displayFore.setPixel32( x + 2, y, foregroundColor );
						}
						if ( b & 0x40 )
						{
							displayFore.setPixel32( x + 1, y, foregroundColor );
						}
						if ( b & 0x80 )
						{
							displayFore.setPixel32( x + 0, y, foregroundColor );
						}
					}
							...
							if ( sprite.multicolor )
							{
								...
								if ( sprite.expandHorizontal )
								{
									...
									while ( v != 0 )
									{
										...
										if ( c != 0 )
										{
											bm.fillRect( rect( xCur, y1, 4, 1 ), spriteColors[ c ] );
										}
										v >>= 2;
										xCur -= 4;
									}
